...
def get_feature_target(
    ...
    X_train = app_train.copy().drop(columns=[target_column_name])
    y_train = app_train[ target_column_name ]
    X_test = app_test.copy().drop(columns=[ target_column_name ])
    y_test = app_test[ target_column_name ]
